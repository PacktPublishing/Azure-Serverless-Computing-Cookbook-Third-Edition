...
namespace AzureFunctions.Tests
{
    public class ShouldExecuteAzureFunctions
    {
        ...
        {
            var httpRequestMock = new Mock<HttpRequest>(); var LogMock = new Mock<ILogger>();
            ...
            queryStringParams.Add("name", "Praveen Sreeram"); var result = await

            HttpTriggerCSharpFromVS.Run(httpRequestMock.Object, LogMock.Object); var resultObject = (OkObjectResult)result; Assert.Equal("Hello, Praveen Sreeram",
             resultObject.Value);
        }
    }
}
